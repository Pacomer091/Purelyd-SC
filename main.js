...
function setupEventListeners() {
    ...
    if (mobBulkImport) {
        mobBulkImport.onclick = () => {
            if (bulkImportBtn) bulkImportBtn.click();
            mobileAddOverlay.classList.remove('active');
        };
    }
    ...
    if (mobNewPlaylist) {
        mobNewPlaylist.onclick = () => {
            if (newPlaylistBtn) newPlaylistBtn.click();
            mobileAddOverlay.classList.remove('active');
        };
    }
    ...
    if (mobNavUploads) {
        mobNavUploads.onclick = () => {
            if (navUploads) navUploads.click();
            mobileLibOverlay.classList.remove('active');
        };
    }
    ...
    if (mobNavPlaylists) {
        mobNavPlaylists.onclick = async () => {
            if (mobileLibOverlay) mobileLibOverlay.classList.remove('active');
            if (typeof showAuthModal === 'function' && !currentUser) return showAuthModal();
            await loadPlaylists();
